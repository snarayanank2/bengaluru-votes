...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    '',
    '## Voter FAQs and guides',
    `- Voter FAQs: ${abs('/voter-faqs')}`,
    `- Voter ID issuance & update: ${abs('/voter-faqs#registration')}`,
    `- How to vote: ${abs('/voter-faqs#voting-day')}`,
    `- Find your polling booth: ${abs('/')}`,
